...
export const NinthSection = () => {
    ...
    return <section id="ninthSection">
        ...
        <section ref={ref} id="ninthSectionSticky">
            <img style={{filter: animationStep >= 1 ? 'brightness(1)' : 'brightness(0.3)', width: animationStep >= 2 ? '95%' : '100%', height: animationStep >= 2 ? '720px' : '900px', top: animationStep >= 2 ? '3svh' : 0, borderRadius: animationStep >= 2 ? 360 : 0}} src={"/ninthSection/banner.png"} alt="Imagen banner" id="ninthSectionBanner"/>
            <div id="ninthSectionTextContainer">
                <div className='animationTextUp'>
