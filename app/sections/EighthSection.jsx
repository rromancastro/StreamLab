...
export const EighthSection = () => {
    ...
    return <section id="eighthSection">
        <section id="eighthSectionSticky">
            <motion.p id="eigthSectionTitle" style={{opacity: opacityText1}}>¿DUDAS, CONSULTAS O SUGERENCIAS?</motion.p>
            ...
            <motion.div style={{opacity: opacityRedes}} id="eighthSectionRedesContainer">
                ...
                <div className="eighthSectionRed" onMouseLeave={()=>setUseMail(false)}>
                ...
                <div className="eighthSectionRed" onMouseLeave={()=>setUseRedes(false)}>
            ...
            <motion.p id="eigthSectionUbi" style={{opacity: opacityText2}}><LuMapPin color="#9D4EDD"/> UBICACIÓN ACCESIBLE</motion.p>
        </section>
    </section>
}