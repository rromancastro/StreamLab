...
export const SixthSection = () => {
    ...
    return <section id="sixthSection">
        ...
        <section ref={ref} id="sixthSectionSticky">
            ...
            <img className="sixtSectionImg" src={"/sixthSection/img2.png"} alt="Imagen 1" style={{right: animationStep >= 7 ? "0%" : '0' , top: animationStep >= 7 ? '280px' : '100vh', opacity: animationStep >= 7 ? 1 : 0}} />
            <img className="sixtSectionImg" src={"/sixthSection/img1.png"} alt="Imagen 1" style={{left: animationStep >= 7 ? "5%": '0' , top: animationStep >= 7 ? '280px' : '100vh', opacity: animationStep >= 7 ? 1 : 0}} />
